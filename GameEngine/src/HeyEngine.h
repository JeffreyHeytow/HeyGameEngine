...
public:
    HeyEngine( const char* winName, const int winWidth, const int winHight );
    virtual ~HeyEngine();

	//required overloading
	virtual void InitializeGame() = 0;
	virtual void LoadGameContent() = 0;
	virtual void UpdateGame(float currentTime) = 0;
	virtual void DrawGame() = 0;
	virtual void UnLoadGameContent() = 0;
...
private :
	...
	//force a call to the appropriate constructor
	HeyEngine();
